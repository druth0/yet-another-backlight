 ...
 * backlight level.
 */
#define KEYBOARD_BACKLIGHT_FILENAME "/sys/class/backlight/intel_backlight/brightness";

/*
 * The name identifying the file to interact with as the maximum keyboard
 * backlight level.
 */
#define MAX_KEYBOARD_BACKLIGHT_FILENAME "/sys/class/backlight/intel_backlight/brightness";
